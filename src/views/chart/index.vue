<template>
    <div class="custom-select-container">
        <el-input v-model="selectedItem" placeholder="请选择学院" readonly @click="openDialog">
            <template #suffix>
        ...
        <el-dialog title="请选择学院" v-model="dialogVisible" width="400px" destroy-on-close :show-footer="false"
            append-to-body>
            <el-table :data="paginatedCollegeList" @row-click="handleRowSelect" :loading="tableLoading"
...
const collegeList = ref<Array<collegeInfo>>([])
const tableLoading = ref<boolean>(false)
const currentPage = ref(1)
const pageSize = ref(10)

const emits = defineEmits<{
    selected: [collegeName: string]
}>()
